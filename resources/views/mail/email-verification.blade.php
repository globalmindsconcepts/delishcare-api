								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0">
								  ...
								  <tr>
									<td style="padding-right: 0px;padding-left: 0px; padding-bottom:30px; padding-top:30px" align="center">			  
                                         <lottie-player src="#"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"    autoplay></lottie-player>	 										 
									</td>
								  </tr>
								    <tr>
										  <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 60px;font-family:'Raleway',sans-serif;padding-bottom:30px" align="left">
											  <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 20px; padding-bottom:10px; "><strong>{{$data['verification_code']}}</strong></h1>   
											  <p class="v-font-size " style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 12px;">Here is your <strong>Email verification code</strong> to complete the registration process. 
