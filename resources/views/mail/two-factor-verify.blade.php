								  ...
								  <tr>
								    ...
								    <tr>
										  <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 60px;font-family:'Raleway',sans-serif;padding-bottom:30px" align="left">
											  ...
											  <p class="v-font-size " style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 12px;">Here is your <strong>Two Factor Atuhentication Code</strong> to complete the 2FA process. 
